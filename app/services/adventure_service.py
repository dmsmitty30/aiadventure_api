from app.database import get_adventure_collection, get_adventure_by_id, get_node_by_id, get_node_by_level, get_all_adventures
from bson.objectid import ObjectId
#from app.services.auth_service import hash_password, verify_password
from app.services.user_service import decode_access_token
from app.services.chatgpt_service import askOpenAI_structured, developerMessage, userMessage, assistantMessage
...
async def generate_new_story(prompt, perspective, min_words, max_words):
    ...
    option_instructions = developerMessage(f"""
...
async def generate_new_node(adventure_id, node_id, selected_option, end_after_insert):
    ...
    if end_after_insert==Outcomes.FINISH:
        ...
        continuation_text="Text for the final chapter of the story, in which the protagonist dies."
    ...
    context.append(developerMessage(f"""
...
async def fetch_adventures(owner_id):
    if owner_id:
        ...
        for adventure in adventures:
            output.append({"id":str(adventure["_id"]), 
